...
namespace StarterAssets
{
	public class StarterAssetsInputs : MonoBehaviour
	{
		...
		public void OnCamSwitch(InputValue value)
		{
			CamSwitchInput(value.isPressed);
		}
	...
	// old input sys if we do decide to have it (most likely wont)...
		...
		public void CamSwitchInput(bool newCamSwitchState)
		{
			if(newCamSwitchState)
			{
				camSwitch = !camSwitch;
			}
		...
		public void TakeDamageInput(bool newTakeDamageState)
		{
			takeDamage = newTakeDamageState;
		}
